...
class Funcionario{
  constructor(nome,idade,salarioBase){
    this.nome = nome; //Nome funcionario
    this.idade = idade; //Idade funcionario
    this.salarioTotal = 0  //Total salario antes do calculo
  }

  calcularSalario(){
    this.salarioTotal = this.salarioBase;  //Não possui salario ainda
  }
}

class Professor extends Funcionario{
  constructor(nome,idade,salarioBase,disciplina,horasAulaPorSemana){
    super(nome,idade,salarioBase);  //Chama a propriedade Funcionario
    this.disciplina = disciplina;  //Disciplina professor
    this.horasAulaPorSemana = horasAulasPorSemana;
  }

  calcularSalario(){
    const valorHoraAula = 53.5;  //Valor hora trabalhada
    this.salarioTotal = this.horasAulaPorSemana * valorHoraAula //Multiplica o valor hora pelo o tempo trabalhado
  }
}
